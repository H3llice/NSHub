...
function renderFormularioRelatorio(r, empresas) {
  ...
  return `
    <div style="margin-top:20px;">
      ...
      <h5 style="margin:20px 0 10px;">Identificação</h5>
      ...
      <h5 style="margin:24px 0 10px;">Lista de Verificação e Reparos</h5>
      ...
      <h5 style="margin:24px 0 10px;">Checklist de Componentes</h5>
      ...
      <h5 style="margin:24px 0 10px;">Teste de Flutuadores</h5>
      <table class="table-certificados">
      ...
      <h5 style="margin:24px 0 10px;">Testes IMO — Resolução A.761(18)</h5>
      ...
      <h5 style="margin:24px 0 10px;">Revisão Anual e Observações</h5>
      <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
        <div>
